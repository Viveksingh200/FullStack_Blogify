  ...
  return (
    <>
      <div className="min-h-screen w-full font-serif">
        <Link to="create" className="fixed size-14 text-amber-400 cursor-pointer flex items-center justify-center border rounded-full border-amber-400 bg-amber-50/50 transition-colors hover:bg-amber-50 bottom-10 right-10">
        <Plus />
        </Link>
        <Navbar />
        <Hero />
